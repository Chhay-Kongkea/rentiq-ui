...
export const userApi = api.injectEndpoints({
  endpoints: (builder) => ({
    ...
    createItemRequest: builder.mutation<UserItemRequest, { categoryId: number; title: string; description?: string; budgetMin?: number; budgetMax?: number; neededFrom: string; neededTo: string; latitude: number; longitude: number; radiusKm?: number }>({ query: (body) => ({ url: "/item-requests", method: "POST", body }), invalidatesTags: [{ type: "User", id: "ITEM-REQUESTS" }] }),
