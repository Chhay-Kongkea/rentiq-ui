...
export default function CategoryCard({ image, title, count }: CategoryCardProps) {
  return (
    <div className="flex flex-col items-center justify-between rounded-xl border border-gray-100 bg-white p-3.5 shadow-sm transition-all hover:shadow-md cursor-pointer">
