...
export default function ReadyToRentSection() {
  return (
    <section className="mx-auto w-full max-w-7xl px-4 sm:px-8 py-16 relative overflow-hidden">
      <div className="w-full bg-gradient-to-r from-[#FFF5F5] via-[#FFF1F2] to-[#FFD8D8] py-16 px-4 sm:px-8 relative overflow-hidden border-t border-b border-rose-100/50">
