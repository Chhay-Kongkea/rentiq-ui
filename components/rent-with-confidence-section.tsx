...
export default function RentWithConfidenceSection() {
  return (
    <section className="w-full bg-white py-24 px-4 sm:px-8 overflow-hidden">
      <div className="mx-auto max-w-7xl flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-16">
        
        {/* Left Content Side */}
        <div className="flex-1 max-w-xl flex flex-col items-start text-left z-10">
          ...
          <p className="text-neutral-500 text-base sm:text-lg leading-relaxed mb-8">
            Rentiq bridges the gap between professionals and the high-end machinery they need. Every listing is inspected for quality, and every transaction is backed by our full-coverage guarantee.
          </p>
